          ...
          <View style={styles.profileInfoContainer}>
            ...
            {selectedBanners && selectedBanners.length > 0 ? (
              ...
              <View style={styles.noQuizzesContainer}>
                ...
                <Text style={styles.noQuizzesTitle}>No Quizzes Completed Yet</Text>
                <Text style={styles.noQuizzesSubtext}>
                  This user has yet to take any quizzes
                </Text>
                <Text style={styles.noQuizzesHint}>
                  Take personality and lifestyle quizzes to show off your unique traits!
                </Text>
              </View>
            )}
            ...
            {scrollY ? (
              <Animated.View
                style={[styles.exploreMoreContainer, { opacity: exploreMoreOpacity }]}
              >
